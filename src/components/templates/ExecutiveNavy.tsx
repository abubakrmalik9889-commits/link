...
export const ExecutiveNavy = forwardRef<HTMLDivElement, TemplateProps>(
  ({ resume }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className="w-full max-w-[210mm] mx-auto bg-white text-black font-serif"
        style={{ minHeight: '297mm' }}
      >
        {/* Header */}
        <div className="px-12 pt-10 pb-6 text-center border-b-2 border-[#1e3a5f]">
        ...
        <div className="px-12 py-6">
          ...
          {summary && (
            <div className="mb-6">
              <h2 className="text-xl font-bold text-[#1e3a5f] border-b border-[#1e3a5f] pb-1 mb-3">
                SUMMARY
              </h2>
          ...
          {experience.length > 0 && (
            <div className="mb-6">
              <h2 className="text-xl font-bold text-[#1e3a5f] border-b border-[#1e3a5f] pb-1 mb-4">
                PROFESSIONAL EXPERIENCE
              </h2>
...
ExecutiveNavy.displayName = 'ExecutiveNavy'
